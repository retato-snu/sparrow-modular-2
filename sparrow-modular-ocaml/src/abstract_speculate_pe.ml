...
let residual_artifact_json ?residual_dir result =
  ...
  `Assoc [
    ...
    "residual_solver_run", result.stage2_output.StageT.execution_log |> member "residual_solver_run";
    "solver_backed_residual_fixpoint", result.stage2_output.StageT.execution_log |> member "solver_backed_residual_fixpoint";
    "solver_iteration_count", result.stage2_output.StageT.execution_log |> member "solver_iteration_count";
    "changed_cell_count", result.stage2_output.StageT.execution_log |> member "changed_cell_count";
    "residual_equation_count", result.stage2_output.StageT.execution_log |> member "residual_equation_count";
    "enqueued_equation_count", result.stage2_output.StageT.execution_log |> member "enqueued_equation_count";
    "state_read_count", result.stage2_output.StageT.execution_log |> member "state_read_count";
    "seed_input_read_count", result.stage2_output.StageT.execution_log |> member "seed_input_read_count";
    "exact_cell_dependencies", result.stage2_output.StageT.execution_log |> member "exact_cell_dependencies";
    "equation_apply_reads_solver_state", result.stage2_output.StageT.execution_log |> member "equation_apply_reads_solver_state";
    "worklist_drained", result.stage2_output.StageT.execution_log |> member "worklist_drained";
    "overlay_only", result.stage2_output.StageT.execution_log |> member "overlay_only";
    "residual_fixpoint_restart", result.stage2_output.StageT.execution_log |> member "residual_fixpoint_restart";
